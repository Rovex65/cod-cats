(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function i(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(e){if(e.ep)return;e.ep=!0;const s=i(e);fetch(e.href,s)}})();const g=window.location.pathname,c=document.querySelectorAll(".header-nav-link");let r=!1;c.forEach(t=>{const o=t.getAttribute("href");g.endsWith(o.slice(2))&&(t.classList.add("nav-link-active"),r=!0)});r||c[0].classList.add("nav-link-active");const h="data:image/png;base64,",d="data:image/png;base64,",A="/cod-cats/assets/icons-91f42774.svg#icon-close";function m({author:t,book_image:o,title:i,_id:l}){return`<li class="book-item" data-book-id="${l}">
          ...
          </li>`}function p({image:t,title:o,category:i,description:l,author:e,buyLinks:s}){return`<li class="shop-list-book-card">
  ...
  <div class="shop-list-book-info">
      ...
      <div class="shop-list-product-footer">
          ...
          <div class="shop-list-book-stores">
              <a href="${s[0].url}" target="_blank"><img src="${h}" class="shop-list-amazon"></a>
              <a href="${s[1].url}}" target="_blank"><img src="${d}" class="shop-list-apple"></a>
          </div>
      </div>
  </div>
</li>`}function u({list_name:t,books:o}){const i=o.map(m).join("");return`<section class="books-category">
              <h3 class="category-title">${t}</h3>
              <ul class="books-list">${i}</ul>
              <button type="button" class="button" data-category="${t}">See more</button>
          </section>`}function b(t){return'<h1 class="main-title">Best Sellers <span>Books</span></h1>'+t.map(u).join("")}function H(t){const o=t.trim().split(" "),i=o.splice(o.length-1).join("");return`<h1 class="main-title">
          ${o.join(" ")} <span>${i}</span>
        </h1>`}function Q(t,o){const i=H(o),l=t.map(m).join("");return`${i}
      ...
      <div class="modal-wrap">
        ...
        <div class="modal-book-wrap">
          ...
          <div class="modal-logos-wrap">
            <a href="${i[0].url}" target="blank"><img src="${h}" alt="logo amazon" class="modal-shop-list-amazon" /></a>
            <a href="${i[1].url}" target="blank"><img src="${d}" alt="logo apple" class="modal-shop-list-apple" /></a>
          </div>
        </div>
      </div>
...
//# sourceMappingURL=switch-theme-65fe5394.js.map
