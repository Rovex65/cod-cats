(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();function A(){const e=document.getElementById("burgerToggle"),t=document.getElementById("burgerMenu"),s=document.querySelector("header");e.addEventListener("click",function(){t.classList.toggle("burger-menu-show"),t.classList.contains("burger-menu-show")?(e.innerHTML=`
        ...
        <svg width="28" height="28">
          ...
          </li>`}function H({image:e,title:t,category:s,description:n,author:o,buyLinks:i}){return`<li class="shop-list-book-card">
  ...
  <div class="shop-list-book-info">
      ...
      <div class="shop-list-product-footer">
          ...
          <div class="shop-list-book-stores">
              <a href="${i[0].url}" target="_blank"><img src="${g}" class="shop-list-amazon"></a>
              <a href="${i[1].url}}" target="_blank"><img src="${u}" class="shop-list-apple"></a>
          </div>
      </div>
  </div>
</li>`}function f({list_name:e,books:t}){const s=t.map(m).join("");return`<section class="books-category">
              <h3 class="category-title">${e}</h3>
              <ul class="books-list">${s}</ul>
              <button type="button" class="button" data-category="${e}">See more</button>
          </section>`}function L(e){return'<h1 class="main-title">Best Sellers <span>Books</span></h1>'+e.map(f).join("")}function k(e){const t=e.trim().split(" "),s=t.splice(t.length-1).join("");return`<h1 class="main-title">
          ${t.join(" ")} <span>${s}</span>
        </h1>`}function B(e,t){const s=k(t),n=e.map(m).join("");return`${s}
          <section class="books-category single">
            <ul class="books-list">${n}</ul>
          </section>`}function j({author:e,book_image:t,buy_links:s,description:n,title:o},i,l){return`<div class="modal">
      ...
      <div class="modal-wrap">
        ...
        <div class="modal-book-wrap">
          ...
          <p class="modal-book-author">${e}</p>
          <p class="modal-book-descr">
            ${n}
          </p>
          <div class="modal-logos-wrap">
            <a href="${s[0].url}" target="blank"><img src="${g}" alt="logo amazon" class="modal-shop-list-amazon" /></a>
            <a href="${s[1].url}" target="blank"><img src="${u}" alt="logo apple" class="modal-shop-list-apple" /></a>
          </div>
        </div>
      </div>
      <div class="modal-btn-add">
        <button type="button" class="${l.btnClass}" data-id="${i}">${l.btnText}</button>
        <p class="modal-btn-text">
          Сongratulations! You have added the book to the shopping list. To
          delete, press the button “Remove from the shopping list”.
        </p>
      </div>
    </div>`}function x(e){return e.map(H).join("")}const a=document.getElementById("toggleSwitch");a.addEventListener("change",Q);localStorage.getItem("darkMode")==="true"&&(a.checked=!0,document.body.classList.add("dark"));function Q(){a.checked?(document.body.classList.add("dark"),localStorage.setItem("darkMode","true")):(document.body.classList.remove("dark"),localStorage.setItem("darkMode","false"))}export{L as a,B as b,x as c,j as t};
//# sourceMappingURL=switch-theme-0f27450b.js.map
