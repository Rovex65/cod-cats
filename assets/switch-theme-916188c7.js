(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();function m(){const t=document.getElementById("burgerToggle"),e=document.getElementById("burgerMenu"),s=document.querySelector("header");t.addEventListener("click",function(){e.classList.toggle("burger-menu-show"),e.classList.contains("burger-menu-show")?(t.innerHTML=`
        ...
        <svg width="28" height="28">
          ...
          </li>`}function v({image:t,title:e,category:s,description:n,author:o,buyLinks:i}){return`<li class="shop-list-book-card">
  ...
  <div class="shop-list-book-info">
      ...
      <div class="shop-list-product-footer">
          ...
          <div class="shop-list-book-stores">
              <a href="${i[0].url}" target="_blank"><img src="${h}" class="shop-list-amazon"></a>
              <a href="${i[1].url}}" target="_blank"><img src="${d}" class="shop-list-apple"></a>
          </div>
      </div>
  </div>
</li>`}function H({list_name:t,books:e}){const s=e.map(g).join("");return`<section class="books-category">
              <h3 class="category-title">${t}</h3>
              <ul class="books-list">${s}</ul>
              <button type="button" class="button" data-category="${t}">See more</button>
          </section>`}function Q(t){return'<h1 class="main-title">Best Sellers <span>Books</span></h1>'+t.map(H).join("")}function b(t){const e=t.trim().split(" "),s=e.splice(e.length-1).join("");return`<h1 class="main-title">
          ${e.join(" ")} <span>${s}</span>
        </h1>`}function k(t,e){const s=b(e),n=t.map(g).join("");return`${s}
          <section class="books-category single">
            <ul class="books-list">${n}</ul>
          </section>`}function B({author:t,book_image:e,buy_links:s,description:n,title:o},i,l){return`<div class="modal">
      ...
      <div class="modal-wrap">
        ...
        <div class="modal-book-wrap">
          ...
          <div class="modal-logos-wrap">
            <a href="${s[0].url}" target="blank"><img src="${h}" alt="logo amazon" class="modal-shop-list-amazon" /></a>
            <a href="${s[1].url}" target="blank"><img src="${d}" alt="logo apple" class="modal-shop-list-apple" /></a>
          </div>
        </div>
      </div>
    ...
    </div>`}function L(t){return t.map(v).join("")}const a=document.getElementById("toggleSwitch");a.addEventListener("change",f);localStorage.getItem("darkMode")==="true"&&(a.checked=!0,document.body.classList.add("dark"));function f(){a.checked?(document.body.classList.add("dark"),localStorage.setItem("darkMode","true")):(document.body.classList.remove("dark"),localStorage.setItem("darkMode","false"))}export{Q as a,k as b,L as c,B as t};
//# sourceMappingURL=switch-theme-916188c7.js.map
