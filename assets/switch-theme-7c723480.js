(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function i(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=i(o);fetch(o.href,s)}})();const u=window.location.pathname,c=document.querySelectorAll(".header-nav-link");let d=!1;c.forEach(t=>{t.getAttribute("href").endsWith(u)&&(t.classList.add("nav-link-active"),d=!0)});d||c[0].classList.add("nav-link-active");function p({author:t,book_image:e,title:i,_id:a}){return`<li class="book-item" data-book-id="${a}">
          ...
          </li>`}function m(t){const{book_image:e,title:i,list_name:a,description:o,author:s,buy_links:l}=t;return`<li class="shop-list-book-card">
  ...
  <div class="shop-list-book-info">
      ...
      <div class="shop-list-product-footer">
...
</li>`}function h({list_name:t,books:e}){const i=e.map(p).join("");return`<section class="books-category">
          ...
          ${e.join(" ")} <span>${i}</span>
        </h1>`}function b(t,e){const i=f(e),a=t.map(p).join("");return`${i}
...
//# sourceMappingURL=switch-theme-7c723480.js.map
